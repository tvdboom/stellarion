...
impl Description for Defense {
    ...
    fn description(&self) -> &str {
        match self {
            ...
            Defense::SpaceDock => {
                "The Space Dock is a colossal orbital-support facility. It partakes in combat, \
                being the most powerful combat unit and the only one with Rapid Fire against the \
                War Sun. Only one can be built per planet. The Space Dock is always visible by \
