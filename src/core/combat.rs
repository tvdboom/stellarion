...
impl Description for CombatStats {
    fn description(&self) -> &str {
        match self {
            ...
            CombatStats::Shield => "The amount of damage a unit can absorb before it starts taking hull damage. The shield is regenerated every round",
            ...
            CombatStats::Speed => "The speed at which a unit travels through space.",
